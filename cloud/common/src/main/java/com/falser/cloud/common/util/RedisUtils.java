...
public class RedisUtils {
    ...
    public long lGetListSize(String key) {
        return Optional.ofNullable(redisTemplate.opsForList().size(key)).orElseThrow(NullPointerException::new);
    }
     ...
     * @return long
     */
    public long hgetSize(String s) {
        return redisTemplate.opsForHash().size(s);
    }
     ...
     * @param obj obj
     */
    public Long hllAdd(String key, Object... obj) {
        return redisTemplate.opsForHyperLogLog().add(key, obj);
    }
